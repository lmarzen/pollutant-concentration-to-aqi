 ...
 *   (1) Air Pollution
 */
#define AUSTRALIA_AQI_DESC_TYPE       AIR_QUALITY
#define CANADA_AQHI_DESC_TYPE         AIR_POLLUTION
#define CHINA_AQI_DESC_TYPE           AIR_QUALITY
#define EUROPEAN_UNION_CAQI_DESC_TYPE AIR_POLLUTION
#define HONG_KONG_AQHI_DESC_TYPE      AIR_POLLUTION
#define INDIA_AQI_DESC_TYPE           AIR_QUALITY
#define SINGAPORE_PSI_DESC_TYPE       AIR_QUALITY
#define SOUTH_KOREA_CAI_DESC_TYPE     AIR_QUALITY
#define UNITED_KINGDOM_DAQI_DESC_TYPE AIR_POLLUTION
#define UNITED_STATES_AQI_DESC_TYPE   AIR_QUALITY
